		...
		for (int i = 0; i < in.words_size; i++) {
			...
			if (!special_flag) {
				...
				FST identifier_au(
					lexem,
					3,
					NODE(104, RELATION('A', 0), RELATION('A', 1), RELATION('B', 0), RELATION('B', 1),
						RELATION('C', 0), RELATION('C', 1), RELATION('D', 0), RELATION('D', 1),
						RELATION('E', 0), RELATION('E', 1), RELATION('F', 0), RELATION('F', 1),
						RELATION('G', 0), RELATION('G', 1), RELATION('H', 0), RELATION('H', 1),
						RELATION('I', 0), RELATION('I', 1), RELATION('J', 0), RELATION('J', 1),
						RELATION('K', 0), RELATION('K', 1), RELATION('L', 0), RELATION('L', 1),
						RELATION('M', 0), RELATION('M', 1), RELATION('N', 0), RELATION('N', 1),
						RELATION('O', 0), RELATION('O', 1), RELATION('P', 0), RELATION('P', 1),
						RELATION('Q', 0), RELATION('Q', 1), RELATION('R', 0), RELATION('R', 1),
						RELATION('S', 0), RELATION('S', 1), RELATION('T', 0), RELATION('T', 1),
						RELATION('U', 0), RELATION('U', 1), RELATION('V', 0), RELATION('V', 1),
						RELATION('W', 0), RELATION('W', 1), RELATION('X', 0), RELATION('X', 1),
						RELATION('Y', 0), RELATION('Y', 1), RELATION('Z', 0), RELATION('Z', 1),
						RELATION('a', 0), RELATION('a', 1), RELATION('b', 0), RELATION('b', 1),
						RELATION('c', 0), RELATION('c', 1), RELATION('d', 0), RELATION('d', 1),
						RELATION('e', 0), RELATION('e', 1), RELATION('f', 0), RELATION('f', 1),
						RELATION('g', 0), RELATION('g', 1), RELATION('h', 0), RELATION('h', 1),
						RELATION('i', 0), RELATION('i', 1), RELATION('j', 0), RELATION('j', 1),
